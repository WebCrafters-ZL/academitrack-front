...
const EsqueciSenha = ({ handleClose }) => {
    ...
    const enviarFormulario = async (event) => {
        ...
        try {
            const response = await axios.post(
                "http://localhost:3000/api/v1/auth/esqueci-senha",
                {
                    email
                }
            );
        ...
        <div style={styles.homePage}>
            ...
            <div style={styles.sidebar}>
                ...
                <Container style={styles.loginContainer}>
                    ...
                    <Link to="/" style={styles.retornarHome}>
...
const styles = {
    ...
    retornarHome: { color: "white", textDecoration: "none", marginTop: "10px" },
    mainContent: {
        flexGrow: 1,
        marginLeft: "400px",
